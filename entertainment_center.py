...
monkey_kingdom = media.Movie(
    "Monkey Kingdom",
    "A documentary about a family of monkeys livin in ancient temple \
    ruins in Sri Lanka.",
    "https://upload.wikimedia.org/wikipedia/en/d/d3/Monkey_Kingdom_poster.jpg",  # noqa
    "https://www.youtube.com/watch?v=0bi8dOHR6Rw")

mcfarland_usa = media.Movie(
    "McFarland USA",
    "A cross country coach in a small California town transforms a \
    team of athletes into championship contenders.",
    "https://upload.wikimedia.org/wikipedia/en/1/12/McFarland%2C_USA_poster.jpg",  # noqa
...
planes_fr = media.Movie(
    "Planes: Fire & Rescue",
    "An animated comedy-adventure film. It is a sequel to the 2013 \
    film Planes.",
    "https://upload.wikimedia.org/wikipedia/en/c/cc/Planes_Fire_%26_Rescue_poster.jpg",  # noqa
